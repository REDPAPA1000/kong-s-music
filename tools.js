...
const classTools = [
  ...
  { key: "chooser", label: "발표도우미", desc: "돌림판 · 사다리타기", tone: "violet", mount: mountChooser,
  ...
  { key: "ambience", label: "배경음악", desc: "활동 시간 배경 소리", tone: "sky", mount: mountAmbience,
  ...
  { key: "board", label: "칠판", desc: "화면에 쓰고 그리기", tone: "green", mount: mountBoard,
  ...
  { key: "seats", label: "자리 바꾸기", desc: "자리를 새로 섞기", tone: "orange", mount: mountSeats,
